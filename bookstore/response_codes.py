...
responses = {
    ...
    "out_of_stock": {
        "status": 400,
        "message": "Product out of stock for that quantity",
    },
    ...
    "integrity_error": {
        "status": 500,
        "message": "Something went wrong with foreign key reference",
    },
    "too_many_otp": {
        "status": 400,
        "message": "You have tried too many times. Please come back again tommorow",
    },
    ...
    "generic_response": {"status": 500, "message": "somethin went wrong"},
}
